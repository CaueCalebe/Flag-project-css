...
{Flag-project-css} é um projeto criado durante o curso The Complete Full-Stack Web Development Bootcamp da professora Angela na plataforma da Udemy.

O desafio proposto para este projeto era a criação de uma bandeira utilizando os estilos do css, com às seguintes tags:

Div, border, margin, background-color, color, position e etc.
...
- [x] O usuário deve ter acesso ao site.
